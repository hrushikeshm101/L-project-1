...
export default function LoginPage() {
  ...
  const handleAuth = async (type: 'login' | 'register', e?: FormEvent) => {
    e?.preventDefault();
    setError('');
    setLoading(true);
        ...
        <form onSubmit={(e) => handleAuth('login', e)} className="space-y-4">
          <div>
            ...
            <input
              ...
              autoComplete="email"
              disabled={loading}
              className="w-full px-4 py-2.5 border border-gray-300 text-black rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition disabled:bg-gray-100"
              value={email}
          ...
          <div>
            ...
            <input
              ...
              disabled={loading}
              className="w-full px-4 py-2.5 text-black border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition disabled:bg-gray-100"
              value={password}
          ...
          <button
            ...
            className="w-full bg-blue-600 text-white py-2.5 rounded-lg font-medium hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed transition shadow-sm flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
